...
[_LOWER] = LAYOUT( \
  ...
  KC_SLSH,    KC_7,    KC_8,    KC_9, _______, _______,                     _______, _______, _______, KC_LABK, KC_RABK, _______, \
  KC_COMM,   KC_4,    KC_5,  KC_6, _______, _______,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD,      \
  KC_DOT,   KC_1,   KC_2,  KC_3, KC_DLR,  KC_PERC, _______, _______, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,        \
                               KC_0, _______, _______, _______, _______,  _______, _______, _______ \
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |VolDwn|volUp | Mute |      |BriDwn|BriUp |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |  UP  |      |      |      |                    | LGUI | RGUI |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
